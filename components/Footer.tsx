    ...
    <footer className="bg-slate-50 pt-16 pb-8 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          ...
          >
            <span className="material-symbols-outlined text-2xl text-slate-400">diversity_1</span>
            <span className="text-slate-800 text-lg font-bold">Mi Pana</span>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <a className="w-10 h-10 bg-white border border-slate-200 rounded-full flex items-center justify-center text-slate-400 hover:text-pink-600 hover:border-pink-200 transition-all" href="#">
              <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
